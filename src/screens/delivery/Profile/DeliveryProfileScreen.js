...
import { fetchProfile, deleteProfile } from '../../../redux/slices/profileSlice';
...
const DeliveryProfileScreen = ({ navigation }) => {
  ...
  const QuickActionsSection = () => (
    <View style={styles.section}>
      ...
      <TouchableOpacity style={styles.actionItem} onPress={() => navigation.navigate('DeliveryHistory')}>
        <View style={styles.actionIcon}>
          <Icon name="history" size={20} color="#019a34" />
        </View>
        <View style={styles.actionContent}>
