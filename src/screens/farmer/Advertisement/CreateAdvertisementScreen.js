...
const CreateAdvertisementScreen = ({ navigation }) => {
  ...
  const handleCreateAdvertisement = () => {
    if (!title.trim()) {
      Alert.alert('Validation Error', 'Please enter a title for your advertisement.');
      return;
    }

    if (!advertisementMessage.trim()) {
      Alert.alert('Validation Error', 'Please enter a message for your advertisement.');
      return;
    }

    if (!fromDate) {
      Alert.alert('Validation Error', 'Please select a start date for your advertisement.');
      return;
    }

    if (!toDate) {
      Alert.alert('Validation Error', 'Please select an end date for your advertisement.');
      return;
    }
